package com.app.IndianBankScrapperr
...
import com.app.IndianBankScrapperr.Services.RecorderService
...
class MainActivity : AppCompatActivity() {
    ...
    fun onAppFlowStarted(view: View) {
        ...
        val inActive = Runnable {
            runOnUiThread {
                Toast.makeText(this, "IndianBank inactive", Toast.LENGTH_LONG).show()
            }
